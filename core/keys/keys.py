...
def setup_default_alphabet():
    ...
    initial_default_alphabet = "air bat cap drum each fine gust harp sit jury crunch look made near odd pit quench red sod trap urge vest whale plex yank zip".split()
